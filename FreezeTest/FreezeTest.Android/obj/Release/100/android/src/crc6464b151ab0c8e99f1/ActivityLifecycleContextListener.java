...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.NFC.ActivityLifecycleContextListener, Plugin.NFC", ActivityLifecycleContextListener.class, __md_methods);
	}
	...
	public ActivityLifecycleContextListener ()
	{
		...
		if (getClass () == ActivityLifecycleContextListener.class)
			mono.android.TypeManager.Activate ("Plugin.NFC.ActivityLifecycleContextListener, Plugin.NFC", "", this, new java.lang.Object[] {  });
	}
